System.register(['angular2/core', 'angular2/common', '../validators/change-password.validator'], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            ChangePasswordFormComponent = (function () {
                function ChangePasswordFormComponent(fb) {
                    ...
                    }, { validator: change_password_validator_1.ChangePasswordValidator.checkCompatibility });
                }
